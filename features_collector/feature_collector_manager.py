...
class FeatureCollectorManager:
    ...
    def collect_features(self,
        ...
        self.calculate_regions_features(
            feature_collector_bank_input, feature_collector_bank_output, logger, req_id)
    ...
    def calculate_regions_features(self,
        ...
        feature_collector_bank_output.population_density = regions_features[
            'population_density']
